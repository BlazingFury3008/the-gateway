...
def seed_v20_disciplines():
    discipline_data = [
        ...
        {"name": "Quietus (Vizier)",
                           "description": "A Vizier expression of Quietus."},
...
def seed_v20_clan():
    ...
    clans_data = [
    {
      ...
      "information": "Clanless Kindred who exist in the cracks of vampiric society—unclaimed, untrusted, and perpetually on probation. Some are accidental outliers, others are survivors who reject lineage politics entirely, but most domains treat them as a problem waiting to happen. Caitiff often build identity through coteries, personal codes, or sheer reputation, because tradition offers them nothing but suspicion.",
    ...
    },
    {
      ...
      "information": "Judges, assassins, and zealots whose lineage frames violence as purpose rather than indulgence. Whether they operate as disciplined enforcers or self-appointed executioners, their culture tends to revolve around debt, verdict, and the weight of chosen targets. Their relationship with Kindred blood is fraught—both taboo and temptation—making them dangerous allies and terrifying enemies.",
    ...
    },
    {
      ...
      "information": "Revolutionaries at heart: philosophers with fists, idealists with torches, and warriors who feel everything too loudly. Brujah carry the impulse to confront injustice—real or perceived—but the same passion that fuels heroism can ignite ruin. They thrive in movements, street-level power, and ideological conflict, and often measure worth by what someone is willing to fight for.",
    ...
    },
    {
      ...
      "information": "Corrupters and liberators—depending on who’s telling the story—who specialize in finding the fault-lines in faith, morality, and self-control. Setites cultivate secrets, vices, and spiritual hunger, preferring temptation over domination and slow transformation over brute force. They move through cults, nightclubs, black markets, and mystic circles like oil through water: unseen until everything’s already changed.",
    ...
    },
    {
      ...
      "information": "Survivors whose Beast rides close to the skin, shaped by wilderness instinct and predatory truth. Gangrel often value freedom over status, travel over court, and action over etiquette—though many still carve out fierce loyalties. Their clan identity is less about hierarchy and more about endurance: you are what you can live through.",
    ...
    },
    {
      ...
      "information": "A dynasty first and a clan second—necromancers and financiers who treat death like an industry and family like a fortress. They broker in ghosts, inheritance, influence, and carefully curated monstrosity, often blurring the line between “business” and “ritual.” To deal with them is to accept that everything—including people—can be monetized, owned, or leveraged beyond the grave.",
    ...
    },
    {
      ...
      "information": "Aristocrats of shadow who believe power is proven, not granted, and that weakness deserves to be consumed. Lasombra culture leans hard into ruthless mentorship: they do not “raise” childer so much as test them until something sharp remains. They flourish in institutions—churches, corporations, criminal empires—anywhere control can be exerted and fear can be made useful.",
    ...
    },
    {
      ...
      "information": "Oracles and catastrophes wrapped in the same skin—Kindred whose perceptions don’t align with consensus reality, but often cut deeper than it. Malkavians can be eerie prophets, unsettling analysts, manic performers, or quiet observers who notice what everyone else edits out. Being near them can feel like listening to a song you almost recognize… and realizing it’s about you.",
    ...
    },
    {
      ...
      "information": "Information is their currency and survival is their art: outcasts forced into invisibility who learned to weaponize it. Nosferatu build networks in sewers, tunnels, server rooms, abandoned buildings, and the unseen infrastructure of cities. Many cultivate bleak humor and pragmatic loyalty—because when society punishes your existence, you learn quickly who’s worth protecting.",
    ...
    },
    {
      ...
      "information": "Wanderers, tricksters, and survivors bound to compulsion and appetite, with reputations that oscillate between charming and disastrous. Ravnos often thrive in motion—roads, trains, temporary havens, shifting identities—because stillness invites consequences. Their talents lean toward misdirection, audacity, and the ability to stay alive when everything says they shouldn’t.",
    ...
    },
    {
      ...
      "information": "Aesthetic predators who devour beauty as surely as blood—artists, patrons, curators, and social magnets with a talent for turning a room into a stage. Toreador can be empathetic and visionary, but also vain, obsessive, and cruel in the way connoisseurs can be cruel. They anchor many domains culturally: trends, scandals, and reputations often pass through their hands first.",
    ...
    },
    {
      ...
      "information": "A clan forged through discipline and paranoia: blood sorcerers who turned structure into survival and hierarchy into weaponry. Tremere approach power like a system—codified, recorded, controlled—and treat secrets as both shield and knife. They are often indispensable in occult matters, but rarely trusted, because their idea of “help” tends to come with clauses.",
    ...
    },
    {
      ...
      "information": "Territorial lords and flesh-shapers whose identity is rooted in ownership—of land, of bodies, of tradition, of fear. The clan’s monstrosity often isn’t impulse; it’s craftsmanship, the cold artistry of reshaping living things into statements. Tzimisce can be eerily hospitable in their domains, but hospitality with them frequently means you’re a guest… in a museum that might decide to reframe you.",
    ...
    {
      "name": "Ventrue",
      "weakness": "The Ventrue have rarified tastes, and they find only one specific type of mortal blood palatable and vital for them. When a player creates a Ventrue character, he should decide with the Storyteller what specific type of blood suits the character, and this choice is permanent. Blood of other types (even animals) simply offers the vampire no blood pool increase, no matter how much he consumes — he simply vomits it back up. This refined palate may be very narrow or very broad — say, the blood of younger siblings, or the blood of [REDACTED EXAMPLE]. Vampiric blood is exempt from this restriction.",
      "information": "Patricians of the Damned who treat leadership like both duty and entitlement, cultivated through etiquette, pressure, and selective mercy. Ventrue maintain courts, enforce traditions, and often define what “respectable” looks like in a domain—while quietly ensuring they sit at the center of it. They prize competence, loyalty, and control, and rarely forgive public failure.",
...

    {
      ...
      "information": "Spirit-touched outcasts shaped by fierce independence and a predatory mysticism that feels older than most sect politics. They often frame themselves as hunters, protectors, or avengers, drawing power through a connection to the unseen that is intimate rather than academic. Where other Kindred build legacies through bloodlines, Ahrimanes feel like they build them through vows—and the spirits that witness them.",
    ...
    },
    {
      ...
      "information": "Nomadic riders and raiders whose culture is built around movement, territory crossed rather than held, and the hard pragmatism of travel. Anda often read like predatory folk-heroes: dangerous, romanticized, and never quite belonging to the cities they pass through. They’re at their best when the road is open and the horizon is a promise—at their worst when forced into permanence.",
...

    {
      ...
      "information": "A stain in the genealogy of the Damned: vampires whose reputation is synonymous with profane bargains, blasphemy, and things that should not be invited inside. Whether they truly serve infernal forces or merely exploit the fear of that accusation, Baali operate as corrupters and saboteurs of certainty. Even rumors of them can destabilize a domain, because panic spreads faster than proof.",
...

    {
      ...
      "information": "Manufactured monsters—war packs engineered for brutality, loyalty, and coordinated violence. They are less a “clan” and more a living weapon system, bound together by shared pain and shared purpose. Encounters with Blood Brothers feel like facing a unit rather than individuals: relentless, synchronized, and terrifyingly unconcerned with personal survival.",
...

    {
      ...
      "information": "Scholars of death who study the border between life and afterlife as if it were a library with locked rooms. Cappadocians carry a funerary calm—curiosity without warmth, reverence without comfort—and often treat mortality as data. Their presence suggests tomb air and candle smoke: not always hostile, but always too familiar with endings.",
...

    {
      ...
      "information": "Redeemers and ascetics who seek meaning beyond predation, framing vampirism as a curse to be mastered rather than indulged. They often form small, disciplined circles focused on purification, restraint, and spiritual practice. In a world where most Kindred politics spiral around power, they stand out as unsettling anomalies—proof that the curse can be interpreted differently.",
...

    {
      ...
      "information": "Kindred whose identities orbit voice, resonance, and the haunting presence of music as both blessing and burden. They move through performance spaces and elite salons as easily as through secret gatherings where song becomes ritual. To meet a Daughter is to wonder if you’re hearing art… or a message meant specifically for your bones.",
...

    {
      ...
      "information": "Forged rather than born, shaped as tools of war and surveillance, carrying the tragedy of being made for someone else’s purpose. Gargoyles often read as stoic, blunt, and intensely loyal to the few who treat them as people rather than assets. Their existence is a walking reminder that the Tremere’s greatest creations were also atrocities.",
...

    {
      ...
      "information": "Macabre returnees with the composure of the grave and the patience of long-buried grudges. They carry the aura of something that survived annihilation and returned with a ledger of names. Harbingers tend to be clinical, bitter, and terrifyingly purposeful—less interested in courtly games than in settling accounts.",
...

    {
      ...
      "information": "Fae-touched occultists who feel like they stepped sideways out of reality, bringing alien etiquette and unsettling calm with them. Kiasyd are often collectors—of stories, artifacts, forbidden texts—pursuing mysteries that don’t always align with Kindred priorities. Their presence can make a room feel slightly wrong, like the shadows are listening in a language you don’t know.",
      "reference": "Vampire The Masquerade 20th Anniversary Edition, Core Rulebook, p404",
      "discipline_1": "Dominate",
      "discipline_2": "Mytherceria",
...

    {
      ...
      "information": "Legendary bodyguards and plague-bearers whose reputation mixes devotion with dread. Lamia often carry themselves like oathbound predators: protective, relentless, and utterly comfortable with violence if it serves their charge. Their curse makes them walking biological threats, turning intimacy into risk and feeding into a potential death sentence.",
...

    {
      ...
      "information": "Territory-bound nature-spirits in vampiric form, less “clan” than local myth given fangs. They often feel older than the politics around them—feral, watchful, and deeply attuned to place. When you deal with a Lhiannan, you’re dealing with a domain that has teeth, and the land tends to remember what you did.",
...

    {
      ...
      "information": "Cannibal necromancers whose hunger is literal and spiritual—sustained not just by blood, but by flesh and the implications that come with it. Nagaraja often operate like morticians, surgeons, or cult priests, normalizing horror through routine. Their presence forces uncomfortable questions: what counts as “food,” what counts as “person,” and what happens when the answer stops mattering.",
...

    {
      ...
      "information": "Tribal protectors and mystics whose identity is bound to chosen people and cultural duty rather than sect ambition. Noiad often read as guardians first—watchful, purposeful, and wary of outsiders who treat their obligations like superstition. They may cooperate with courts when necessary, but their loyalty tends to point inward, toward lineage and responsibility.",
...

    {
      ...
      "information": "Rare and hunted, often seen as healers, martyrs, or monsters depending on who controls the narrative. Salubri tend to move carefully through Kindred society, carrying the weight of being simultaneously useful and unsafe—because anything “too merciful” in vampiric politics becomes suspicious. Many cultivate quiet conviction, the kind that doesn’t need permission to exist.",
...

    {
      ...
      "information": "Walking rot wearing a person’s outline—grim survivors who embody decay with a blunt, almost comedic honesty. Samedi often develop thick skins emotionally because the world reacts to them with disgust before it offers conversation. They can be unsettlingly pragmatic, darkly humorous, and difficult to intimidate: what do you threaten someone with, when they already look like the grave?",
...

    {
      ...
      "information": "Cold scholars of time and consequence, stripped of the emotional volatility that defines their cousins and replaced with something sharper—and lonelier. True Brujah often pursue knowledge, order, and long-term outcomes with ruthless clarity, treating passion as a weakness in others to be predicted and exploited. In court they can appear calm and reasonable right up until you realize they’ve already decided what you are.",
...

    {
      ...
      "information": "Sabbat-aligned executioners whose relationship to “judgment” is warped through sect brutality and unrepentant predation. They keep the clan’s lethal discipline but often strip away the restraint, treating verdict as justification for obsession. Unreliable as allies, terrifying as rivals—because they can rationalize almost anything as deserved.",
...

    {
      ...
      "information": "Shock troops and zealots who embrace the rage other Brujah wrestle with, turning frenzy into identity. They thrive on conflict, intimidation, and the thrill of violence as proof of conviction. Where Brujah idealism can seek change, the antitribu often seek collapse—especially of anything that looks like civilized restraint.",
      "reference": "Vampire The Masquerade 20th Anniversary Edition, Core Rulebook, p429",
      "discipline_1": "Celerity",
      "discipline_2": "Potence",
      "discipline_3": "Presence",
...

    {
      ...
      "information": "Urban predators shaped by concrete wilderness—alleys, rooftops, subways, and the ruthless ecology of crowds. City Gangrel blend feral instinct with street-savvy adaptability, hunting like opportunists rather than traditional nomads. Their Beast wears the city’s animals as a mask: rats, stray dogs, roaches—creatures that survive because no one can truly get rid of them.",
      "reference": "Vampire The Masquerade 20th Anniversary Edition, Core Rulebook, p429",
      "discipline_1": "Celerity",
      "discipline_2": "Obfuscate",
      "discipline_3": "Protean",
...

    {
      ...
      "information": "Rural hunters with a more overtly predatory ethos, often framing themselves as the land’s rightful apex. They value stalking, ambush, and endurance, moving like patient threats through fields, forests, and forgotten roads. In Sabbat contexts they can become terrifyingly simple: identify prey, pursue prey, end prey.",
...

    {
      ...
      "information": "Sabbat lunatics whose madness is often weaponized—visions turned into cruelty, insight twisted into terror. They can be prophets of atrocity, gleeful saboteurs, or unsettling strategists who “know” what will happen and enjoy making it happen. Being near them feels like standing too close to a live wire: fascinating, dangerous, and never predictable.",
      "reference": "Vampire The Masquerade 20th Anniversary Edition, Core Rulebook, p430",
      "discipline_1": "Auspex",
      "discipline_2": "Dementation",
      "discipline_3": "Obfuscate",
...

    {
      ...
      "information": "Ambushers and war-spies who take the Nosferatu survival instinct and sharpen it into sect violence. They trade in fear and leverage, preferring to control territory through unseen dominance rather than open rule. In many packs they become the practical nightmare: the one who already knows your exits, your secrets, and how long you’ve been lying.",
      "reference": "Vampire The Masquerade 20th Anniversary Edition, Core Rulebook, p430",
      "discipline_1": "Animalism",
      "discipline_2": "Obfuscate",
      "discipline_3": "Potence",
...

    {
      ...
      "information": "Clanless Sabbat who turned marginalization into movement—ambitious, resentful, and hungry for recognition. Panders often build solidarity through shared exclusion, but that unity can curdle into ruthless politics when power appears on the table. They’re proof that lineage isn’t the only thing that creates identity; sometimes refusal is enough.",
...

    {
      ...
      "weakness": "Each Ravnos antitribu, just like their parent Clan, has a penchant for some sort of vice — breaking taboos is hard-wired into the Rogues just as it is into the Ravnos proper. When presented with an opportunity to engage in that vice, the Rogue must indulge it unless her player succeeds on a Self-Control or Instincts roll (difficulty 6).",
      "information": "Con artists and taboo-breakers who treat boundaries as invitations and consequences as someone else’s problem. Their vice-driven nature becomes a sect asset: they destabilize, provoke, and exploit weakness with flair. In a domain, they’re the kind of threat that spreads socially before it becomes physical—until it suddenly becomes both.",
      "reference": "Vampire The Masquerade 20th Anniversary Edition, Core Rulebook, p431",
      "discipline_1": "Animalism",
...

    {
      ...
      "information": "Militant cousins who recast salvation through violence—warrior-mystics who believe purity must be taken, not offered. They’re frightening because they can interpret brutality as righteousness and sacrifice as proof of devotion. Where Salubri might heal to preserve humanity, the antitribu often fight to redefine what “worthy” even means.",
      "reference": "Vampire The Masquerade 20th Anniversary Edition, Core Rulebook, p431",
      "discipline_1": "Auspex",
      "discipline_2": "Fortitude",
      "discipline_3": "Valeren",
      "discipline_4": None
    },

    {
      ...
      "information": "A Caribbean offshoot that weaponizes faith and rebellion, turning Setite corruption into something more overtly revolutionary and sect-friendly. They often present as liberators—breaking chains, exposing hypocrisy—while still reveling in temptation and control. Their curse mirrors their identity: they claim light, but it burns them all the same.",
      "reference": "Vampire The Masquerade 20th Anniversary Edition, Core Rulebook",
...

    {
      ...
      "information": "Sadistic aesthetes who treat suffering as art and cruelty as refinement, polishing horror until it sparkles. They thrive in pack dynamics where dominance is performative and humiliation is entertainment. Their danger isn’t just violence—it’s taste: they can make atrocity feel “reasonable” if they frame it beautifully enough.",
      "reference": "Vampire The Masquerade 20th Anniversary Edition, Core Rulebook",
      "discipline_1": "Auspex",
      "discipline_2": "Celerity",
      "discipline_3": "Presence",
...

    {
      ...
      "information": "Sabbat sorcerers marked by betrayal, carrying both the skills of the Warlocks and the stigma of having turned that power against its origin. They often operate like hunted specialists: paranoid, pragmatic, and willing to do ugly work to stay unburned. In the Sabbat they can be invaluable; outside it, they’re a walking invitation to a blood hunt.",
      "reference": "Vampire The Masquerade 20th Anniversary Edition, Core Rulebook",
      "discipline_1": "Auspex",
      "discipline_2": "Dominate",
      "discipline_3": "Thaumaturgy",
...

    {
      ...
      "information": "Crusader-nobles who carry the Ventrue posture of leadership but apply it through sect absolutism and pack-driven conquest. They lead through certainty, discipline, and selective reward, treating obedience as virtue and dissent as failure. With Auspex in the mix, they become chillingly perceptive commanders who read weakness like a map.",
      "reference": "Vampire The Masquerade 20th Anniversary Edition, Core Rulebook",
      "discipline_1": "Dominate",
      "discipline_2": "Fortitude",
      "discipline_3": "Auspex",
...

    {
      ...
      "weakness": "Sabbat Ventrue have the same weakness as their Camarilla brethren. The player decides with the Storyteller what specific type of blood suits the Crusader, and this choice is permanent. Blood of other types (even animals) simply offers the vampire no blood pool increase, no matter how much he consumes",
      "information": "Crusader-nobles who win through force of personality—charisma sharpened into dominance, inspiration twisted into coercion. They often become the pack’s face: the one who makes atrocities sound like destiny and turns fear into loyalty. Presence-focused Crusaders are terrifying because they don’t just command obedience—they make followers want it.",
      "reference": "Vampire The Masquerade 20th Anniversary Edition, Core Rulebook",
      "discipline_1": "Dominate",
      "discipline_2": "Fortitude",
      "discipline_3": "Presence",
...

    {
      ...
      "information": "Mystics whose blood has been steeped in ritual so long it “shows,” like ink leaching through paper. They often read as specialists: the occult technician, the quiet advisor, the one who knows exactly which names not to say aloud. Their power invites attention—supernatural senses catch them easily—so many become layered, careful, and paranoid by necessity.",
...

    {
      ...
      "information": "Artisans and scholars consumed by their work, driven by obsessive focus that can look like inspiration or illness depending on the observer. Viziers collect projects the way others collect trophies—masterpieces, experiments, impossible research—often at the expense of everything practical. Brilliant allies and maddening liabilities: the kind of person who will save you… after they finish the thing they can’t stop doing.",
...

    {
      ...
      "information": "Setite offshoots with a more ascetic, philosophical presentation—less nightclub-serpent, more temple-corridor mystic. They frame temptation as a test, corruption as revelation, and liberation as tearing down false moral structures. That makes them persuasive: they don’t always sound like villains—they sound like someone who wants you to stop lying to yourself.",
      "reference": "Vampire The Masquerade 20th Anniversary Edition, Core Rulebook, p434",
      "discipline_1": "Presence",
      "discipline_2": "Obfuscate",
      "discipline_3": "Serpentis",
...

    {
      ...
      "information": "Predatory jungle Setites shaped by harsh environments and older fears, often presenting as hunters, cult lords, or gods-in-the-green. They blend spiritual authority with practical violence, using local myth and raw survival as leverage. Their vibe is less social seduction and more sacred predator—beautiful in the way a snake is beautiful.",
...

    {
      ...
      "information": "Militant Setites who express the clan’s ethos through force—fighters who still understand temptation, but are comfortable skipping straight to enforcement. They serve as guards, enforcers, and the sharp end of Setite influence, ensuring debts and bargains have consequences. Their presence signals that the cult isn’t just persuasive—it’s protected.",
      "reference": "Vampire The Masquerade 20th Anniversary Edition, Core Rulebook, p435",
      "discipline_1": "Potence",
      "discipline_2": "Obfuscate",
      "discipline_3": "Serpentis",
...

    {
      ...
      "information": "Sea-bound Gangrel whose Beast speaks in salt, pressure, and alien ocean life. Mariners feel half-myth: dockside legends, storm-haunted predators, things sailors warn each other about when fog rolls in. Their mutations and instincts lean strange and inhuman, and many develop a deep-water patience—like something waiting below.",
      "reference": "Vampire The Masquerade 20th Anniversary Edition, Core Rulebook, p435",
      "discipline_1": "Animalism",
      "discipline_2": "Fortitude",
      "discipline_3": "Protean",
...

    {
      ...
      "information": "Recon-focused Gargoyles who live for vantage points, silent approach, and the long watch. They act like living surveillance systems—patient, methodical, and difficult to surprise—especially in cities where rooftops and ruins become their hunting grounds. Their injury-response adds a grim edge: every fight risks making them slower and more brittle until they fully recover.",
...

    {
      ...
      "information": "Guardians built for loyalty and presence, designed to stand where others would flinch and to keep standing after they’re hit. Sentinels can be oddly approachable despite their monstrous appearance, especially if treated with basic respect—many latch onto simple kindness because so few offer it. They read well as steadfast protectors with a quiet sadness: built to defend places that were never truly theirs.",
      "reference": "Lore of the Bloodlines, p.36",
      "discipline_1": "Fortitude",
      "discipline_2": "Potence",
      "discipline_3": "Flight",
...

    {
      ...
      "information": "Front-line stone soldiers meant to break enemies and endure retaliation, thinking in objectives rather than ideals. Warriors tend to be blunt, direct, and terrifyingly committed once a target is chosen. They embody being created as a solution—carrying a soldier’s purpose without necessarily having a soldier’s choice.",
      "reference": "Lore of the Bloodlines, p.36",
      "discipline_1": "Fortitude",
...

    {
      ...
      "information": "A Lasombra subsect drenched in darker dogma—shadow-clergy and abyss-devotees who treat terror as sacrament. They embrace brutality as proof of faith, and their reputation carries whispers of infernal flirtation whether deserved or not. Potence-leaning Angelis Ater feel like executioners in ceremonial robes: heavy-handed, unrelenting, and convinced they’re right.",
...

    {
      ...
      "weakness": "The Angellis Ater have the same weakness as other Lasombra — they do not cast reflections. ",
      "information": "A Lasombra subsect that weaponizes devotion, awe, and dread—leaders who can make damnation sound holy. Presence-leaning Angelis Ater often become cult anchors: the ones who command loyalty through charisma framed as revelation. They’re dangerous because they can unify monsters under a single story and make that story feel inevitable.",
      "reference": "Vampire The Masquerade 20th Anniversary Edition, Core Rulebook, p436",
      "discipline_1": "Daimoinon",
      "discipline_2": "Dominate",
      "discipline_3": "Presence",
...

    {
      ...
      "weakness": "The Angellis Ater have the same weakness as other Lasombra — they do not cast reflections. ",
      "information": "A Lasombra subsect defined by intimate familiarity with the Abyss—shadow-workers who treat darkness as a living tool and sometimes as a companion. Obtenebration-leaning Angelis Ater feel like the nightmare version of a priesthood: they don’t just scare people, they make fear tactile. Their mystique lands best when their vows and practices feel unknowable—things moving where light can’t prove they’re there.",
      "reference": "Vampire The Masquerade 20th Anniversary Edition, Core Rulebook, p436",
      "discipline_1": "Daimoinon",
      "discipline_2": "Dominate",
      "discipline_3": "Obtenebration",
...

    {
      ...
      "information": "Defectors forced into constant caution, carrying Lasombra ruthlessness without Lasombra protection. They tend to be pragmatic, secretive, and intensely strategic—because exposure doesn’t mean embarrassment, it means extinction. They shine as desperate, competent survivors: dangerous not because they’re loud, but because they can’t afford to ever be sloppy.",
      "reference": "Vampire The Masquerade 20th Anniversary Edition, Core Rulebook, p436",
      "discipline_1": "Dominate",
      "discipline_2": "Obtenebration",
      "discipline_3": "Potence",
...

    {
      ...
      "information": "A subtler branch of lunacy—quiet, controlled, and therefore more unsettling. They learned to hide the jagged parts behind etiquette and stillness, weaponizing calm as misdirection. Their horror lands best when the mask slips: the polite conversationalist who has been rearranging your thoughts the whole time.",
...

    {
      ...
      "information": "Mystically inclined Ravnos who dress vice in incense and stagecraft, leaning into fortune-telling, séances, and spiritual performance as both hustle and identity. They present as charismatic guides who know exactly what someone wants to hear—and what that desire costs. Their con is rarely just money; it’s belief, dependence, and the slow erosion of certainty.",
      "reference": "Vampire The Masquerade 20th Anniversary Edition, Core Rulebook, p437",
      "discipline_1": "Animalism",
      "discipline_2": "Auspex",
...

    {
      ...
      "information": "Scholar-sages who treat knowledge like hunger, compelled toward their chosen mysteries with the intensity of addiction. They can be gentle and attentive right up until curiosity takes over and everything else becomes secondary. They make excellent mentor figures whose support is real—but whose fixation can drag a coterie into trouble.",
...

    {
      "name": "Wu Zao (Valeren)",
      "weakness": "The Wu Zao are scholars by nature, and each of them has a special focus. At character creation, the player must select an area of arcane study — the Wan Kuei, the culture of a specific mortal group, a group of mystical tomes lost to the ages, etc. Whenever the opportunity arises to learn something about this subject, the player must make a Willpower roll (difficulty 6) to avoid pursuing that lead to the exclusion of all else.",
      "information": "Scholar-sages whose pursuit of understanding includes martial or disciplinary rigor, framing discovery as something earned through trial. They feel like monastic investigators: calm, watchful, and intensely determined once a question takes root. They don’t seek conflict, but they will not abandon a lead—or a duty—once it matters.",
      "reference": "Vampire The Masquerade 20th Anniversary Edition, Core Rulebook, p438",
      "discipline_1": "Auspex",
      "discipline_2": "Fortitude",
      "discipline_3": "Valeren",
...

    {
      ...
      "information": "Pagan-rooted Warlocks tied to older ways of power, carrying the tension of being both sorcerers and outsiders to mainstream Tremere orthodoxy. They often feel like hedge-priests: ritualists with earthier symbolism, ancestral pacts, and a deep discomfort around hostile faith. Their identity shines when old gods and old bargains collide with modern blood magic’s cold geometry.",
      "reference": "Vampire The Masquerade 20th Anniversary Edition, Core Rulebook, p438",
      "discipline_1": "Auspex",
      "discipline_2": "Presence",
      "discipline_3": "Thaumaturgy",
...

    {
      ...
      "information": "Elemental sorcerers whose magic is rooted in place—storms, stone, soil, and the authority of the land itself. They present as stern, traditional, and territorial, treating leadership as a natural extension of ownership. With Dominate, that becomes chillingly feudal: the land commands, and through them, so do you.",
...

    {
      ...
      "weakness": "As with the rest of the Clan (p. 71): The koldun must rest in the proximity of at least two handfuls of native soil. Failure to meet this requirement halves the koldun’s dice pools every 24 hours, until all pools fall to one die. This penalty remains until they are able to rest for a full day in their earth.",
      "information": "Elemental sorcerers who combine land-bound mysticism with fleshcraft, making territory something you can carve into bodies as well as borders. They feel like warlords or shamans of a cruel ecology—everything is material, everything has a shape, and shape is authority. Their magic lands best when it feels ancient and inevitable, like a mountain deciding what you’re allowed to be.",
      "reference": "Vampire The Masquerade 20th Anniversary Edition, Core Rulebook, p439",
      "discipline_1": "Auspex",
      "discipline_2": "Animalism",
      "discipline_3": "Vicissitude",
...

    {
      ...
      "information": "Traditionalists who reject (or predate) modern fleshcraft trends, anchoring identity in feudal pride, ancestral law, and the sanctity of domain. They can feel eerily civilized in a cruel way—formal hospitality, strict rules, and punishments delivered with calm certainty. They work best as lords of oath and soil: less mad-scientist, more ancient tyrant.",
      "reference": "Vampire The Masquerade 20th Anniversary Edition, Core Rulebook, p439",
      "discipline_1": "Auspex",
      "discipline_2": "Animalism",
      "discipline_3": "Dominate",
...

    {
      ...
      "information": "Fae-marked outsiders whose presence reads as not-quite-consensus, even by Kindred standards. They move like living folklore—strange etiquette, unsettling beauty, and instincts that don’t map cleanly to sect norms. With Mytherceria, lean into glamour and old-story rules: oaths, names, tricks of perception, and the sense that rules exist… just not yours.",
      "reference": "The Black Hand: A Guide To The Tal'Mahe'Ra, p167",
      "discipline_1": "Mytherceria",
      "discipline_2": None,
      "discipline_3": None,
      "discipline_4": None
    },

    {
      ...
      "weakness": "Due to her fae-marked physique, rolls to recognize the Maeghar as otherworldly are at -1 difficulty. Secondly, her fae heritage makes her vulnerable to cold iron: not only do weapons made from cold iron inflict aggravated damage to her, but such damage triggers an immediate roll to avoid either frenzy or Rötschreck as befitting the context. Lastly, a Maeghar feels such revulsion at feeding from a warm, smelly, and sweaty human that she must drain her victim’s blood in a clean container before consuming it. This restriction does not apply when feeding from vampires.",
      "information": "Fae-marked outsiders who combine otherworldly aura with deathly practice, feeling like a crossroads between fairy tale and graveyard. They approach spirits with a familiarity that’s neither priestly nor academic—more like someone who grew up hearing the dead speak back. Necromancy Maeghar land best when uncanny rather than gory: whispers through mirrors, polite conversations with ghosts, and the chill of being noticed by things that shouldn’t care.",
      "reference": "The Black Hand: A Guide To The Tal'Mahe'Ra, p167",
