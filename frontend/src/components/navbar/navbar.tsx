...
export default function Navbar() {
  return (
    <div className="h-16 bg-gray font-[family-name:var(--font-geist-mono)]">
      <h3 className="text-center mt-2 text-lg">The Gateway</h3>
      <div>
  ...
  sub_domains={[
    {
      title: "Vampire: The Masquerade 5th Ed",
      link: "/VTM_5th_Ed",
    },
    {
      title: "Hunter: The Reckoning 5th Ed",
      link: "/HTR_5th_Ed",
    },
    {
      title: "Werewolf: The Apocalypse 5th Ed",
      link: "/WTA_5th_Ed",
    }
  ]}
/>
