    ...
    <div className="container mx-auto p-6">
      ...
      <div className="mt-6 flex justify-center">
        ...
        href={"/character-creation/vtm5/new-character"}
          className="px-8 py-4 sm:text-lg font-semibold tracking-wide bg-gradient-to-r from-red-600 to-black text-white rounded-xl shadow-lg transform hover:scale-105 transition duration-300 text-base"
        >
          + Create a Character
        </Link>
      </div>
